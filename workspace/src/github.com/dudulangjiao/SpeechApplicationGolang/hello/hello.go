...
func main() {
	...
	instructionAddressRegister := stringutil.NewEightBitRegister()
	...
	_, ramOutput0 := ram.ReadWrite('0', '1',
		...
		instructionAddressRegister.ReadWrite('0',
			"00000000"))
	instructionRegister.ReadWrite('1', ramOutput0)

	fmt.Println(ramOutput0)
	fmt.Println("\n", ram, aRegister, bRegister, cRegister, dRegister,
		instructionAddressRegister, instructionRegister)
